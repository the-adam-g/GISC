...
tk.Label(root, text="GISC Interpreter").grid(row=1, column=2, padx=5, pady=5)
tk.Label(root, text="Enter your GISC code here").grid(row=2, column=1, padx=5, pady=5)
tk.Label(root, text="Output").grid(row=2, column=3, padx=5, pady=5)
tk.Label(root, text="Simualted Memory").grid(row=4, column=1, padx=5, pady=5)
tk.Label(root, text="Generated GISC ROM instructions").grid(row=4, column=3, padx=5, pady=5)
...
output2.grid(row=5, column=1, padx=5, pady=5)
output3 = scrolledtext.ScrolledText(root, height=10, width=50)
output3.grid(row=5, column=3, padx=5, pady=5)
